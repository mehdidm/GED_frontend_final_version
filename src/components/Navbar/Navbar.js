...
""}
      ...
      <div className="navbar__right">
        {localStorage.getItem('token') ?
            ...
            {localStorage.getItem('Role') == "INGENIEUR" ?
              <a href="/addUser">
                <button type="button" className="btn btn-info">
                  <i className="fas fa-user-plus"></i> Ajouter utilisateur</button>
              </a> : <div></div>
            }
          </>
          ...
          :
          <a href="/login">
            <button type="button" className="btn btn-info"><i className="fas fa-sign-in-alt"></i> Se connecter</button>
          </a>
        }
